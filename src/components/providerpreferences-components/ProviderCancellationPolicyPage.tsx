...
//   initialData?: CancellationPolicyFormData;
//   onSave: (data: CancellationPolicyFormData) => void;
//   onCancel: () => void;
// }

// const ProviderCancellationPolicyPage: React.FC<EditorFormProps> = ({
//   initialData,
//   onSave,
// }) => {
...
//         {initialData?._id ? 'Edit Cancellation Policy' : 'Add New Cancellation Policy'}
//       </h2>
//       <form onSubmit={handleSubmit}>
//         <div className="mb-6">
//           <Label htmlFor="CancellationPolicyContent">Cancellation Policy Content</Label>
...
// export default ProviderCancellationPolicyPage;
...
const ProviderAboutUsPage: React.FC<EditorFormProps> = ({
  ...
  return (
   <div className="p-6 bg-white rounded-lg shadow-md w-full my-8">
      ...
      <h2 className="text-3xl font-bold text-gray-800 dark:text-white/90 text-center mb-6">
        {initialData?._id ? 'Edit Provider Cancellation' : 'Add New Provider Cancellation'}
      </h2>
      <form onSubmit={handleSubmit}>
        <div className="mb-6">
          <Label htmlFor="Provider Cancellation Content">Provider Cancellation Content</Label>
