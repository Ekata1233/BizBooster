...
export default function SignUpForm() {
  ...
  return (
    <div className="flex flex-col flex-1 lg:w-1/2 w-full overflow-y-auto no-scrollbar  bg-brand-950">
            ...
            <form>
              <div className="space-y-5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <p className="inline-block font-normal text-gray-300 dark:text-gray-400">
