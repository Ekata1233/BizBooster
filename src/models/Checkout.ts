...
export interface ICheckout extends Document {
    ...
    cashfreeMethod?: 'credit_card' | 'upi' | 'net_banking' | 'debit_card' | 'wallet'|'UPI'|'DC';
...
const checkoutSchema = new Schema<ICheckout>({
    ...
    cashfreeMethod: {
        type: String,
        enum: ['credit_card', 'upi', 'net_banking', 'debit_card', 'wallet','UPI','DC'],
        default: null,
    },
    paymentStatus: {
        type: String,
        enum: ['pending', 'paid', 'failed', 'unpaid','partpay'],
        default: 'pending',
    },
    orderStatus: {
        type: String,
