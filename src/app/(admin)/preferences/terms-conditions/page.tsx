...
const AdminAboutUsManagementPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <PageBreadcrumb pageTitle="Manage Terms & Conditions Sections" />
      ...
      <div className="mb-10 ">
        ...
        <ComponentCard title={currentFormEntry._id ? 'Edit Terms and Conditions Section' : 'Add New Terms and Conditions Section'}>
          <TermsConditionsPage
      ...
      <ComponentCard title="Existing Terms and Conditions Sections">
