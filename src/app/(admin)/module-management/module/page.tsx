                                    ...
                                    <Draggable key={m.id} draggableId={m.id} index={idx}>
                                        {(provided, snapshot) => (
                                            <div
                                                ...
                                                className={`p-4 rounded-lg border shadow bg-white flex flex-col gap-3 ${snapshot.isDragging && 'ring-2 ring-blue-400 bg-blue-50'
                                                    }`}
                                            >
                                                ...
                                                <span className={`px-2 py-1 rounded text-xs font-bold ${m.status === "Active"
