...
//   const handleEdit = (webId: string, videoIdx: number) => {
//     // router.push(`/academy/webinars/updatemodals/${id}`);
//      router.push(`/academy/webinars-management/updateModals/${webId}/${videoIdx}`);
//   };
...
//       <Link href="/academy/webinars-management/webinars-list" passHref>
...
//           <div className="space-y-8 max-h-[75vh] overflow-y-auto pr-6"> 
//             <div>
...
interface Video {
    ...
    videoDescription: string;
    videoUrl: string;
    videoImageUrl?: string; // <--- ADDED THIS LINE
}
...
const WebinarDetailPage: React.FC = () => {
    ...
    const { webinars, deleteTutorial,  deleteWebinar } = useWebinars();
                            ...
                            <div key={idx} className="border border-blue-100 rounded-2xl p-5 shadow-md flex flex-col gap-4 bg-white hover:shadow-xl hover:border-blue-300 transition-all duration-300">
                                ...
                                {v.videoImageUrl && (
                                    <div className="relative w-full h-40 rounded-lg overflow-hidden mb-2">
                                        <Image
                                            src={v.videoImageUrl}
                                            alt={`Thumbnail for ${v.videoName || 'Video'}`}
                                            layout="fill" // Use layout="fill" to make the image fill the container
                                            objectFit="cover" // Cover the container without distorting aspect ratio
                                ...
                                {!v.videoImageUrl && (
                                    <div className="w-full h-40 bg-gray-100 rounded-lg flex items-center justify-center text-gray-500 text-sm mb-2">
                                        No Thumbnail
                                    </div>
                                )}
                                ...
                                <strong>Video Url:
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="text-blue-600 underline hover:text-blue-800 transition-colors duration-200 ml-2" // Added ml-2 for spacing
                                    >
                                        View Video
                                    </a>
                                </strong>
