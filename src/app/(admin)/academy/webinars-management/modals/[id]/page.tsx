...
const EditWebinarPage = () => {
  ...
  const { id } = useParams();
  const { webinars, updateWebinar } = useWebinars();
  ...
  const validateForm = (): boolean => {
    ...
    // Webinar Description validation
    if (!description.trim()) {
      newErrors.description = 'Webinar Description is required.';
    } else if (!validateDescription(description)) {
      newErrors.description = 'Webinar Description contains invalid characters.';
    }
