...
//     //   render: (r: TableData) => (
//     //     <ul>
//     //       {r.displayVideoDescriptions.map((d, i) => (
//     //         <li key={i}>{d}</li>
//     //       ))}
//     //     </ul>
//     //   ),
...
//       accessor: 'displayVideoNames',
//       render: (r: TableData) => (
//         // Added list-disc and pl-5 classes here
...
//     accessor: 'displayVideoDescriptions',
//     render: (r: TableData) => (
//       // Added list-disc, pl-5, max-w-xs, and break-words classes here
//       <ul className="list-disc pl-5 max-w-xs break-words text-gray-700 text-sm">
//         {r.displayVideoDescriptions.map((d, i) => (
//           <li key={i}>{d}</li>
//         ))}
//       </ul>
